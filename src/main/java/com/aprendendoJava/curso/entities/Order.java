...
public class Order implements Serializable{
	...
	//associação com a classe User
	/*criando relacionamento entre as tabelas de User
	 * e order no JPA. Na classe pedido tenho uma 
	 * associação de muitos pedidos para Um usuário
	...
	private User client;
	/*
	 * O atrituto orderItemns é um conjunto de items que
	 * pode estar associado a somente um pedido. Ou seja 
	 * vários produtos itemns(produtos) podem estar em um
	 * pedido
	 */
